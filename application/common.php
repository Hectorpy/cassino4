...
require '/www/wwwroot/77vipgame.com/vendor/phpmailer/phpmailer/src/Exception.php';
require '/www/wwwroot/77vipgame.com/vendor/phpmailer/phpmailer/src/PHPMailer.php';
require '/www/wwwroot/77vipgame.com/vendor/phpmailer/phpmailer/src/SMTP.php';
 
$mail = new PHPMailer(true);     
// dump($mail);die;// Passing `true` enables exceptions 
try { 
    //服务器配置 
    ...
    $mail->Username = 'sosu001@163.com';                // SMTP 用户名  即邮箱的用户名 
    $mail->Password = 'DVLJOZWIXZOBVWWT';             // SMTP 密码  部分邮箱是授权码(例如163邮箱) 
    $mail->SMTPSecure = 'ssl';                    // 允许 TLS 或者ssl协议 
    $mail->Port = 465;                            // 服务器端口 25 或者465 具体要看邮箱服务器支持 
 
    $mail->setFrom('sosu001@163.com', '99vip');  //发件人 
    $mail->addAddress($toUser);  // 收件人 
    //$mail->addAddress('ellen@example.com');  // 可添加多个收件人 
    $mail->addReplyTo('sosu001@163.com', 'info'); //回复的时候回复给哪个邮箱 建议和发件人一致 
